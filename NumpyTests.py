...
class TestCheckers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reference_img = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\checker.npy')
        self.reference_img2 = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\checker2.npy')
...
class TestCircle(unittest.TestCase):
    def setUp(self):
        ...
        self.reference_img = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\circle.npy')
        self.reference_img2 = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\circle2.npy')
...
class TestSpectrum(unittest.TestCase):
    ...
    def setUp(self):
        # Loads the reference images
        self.reference_img = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\spectrum.npy')
        self.reference_img2 = np.load('C:\\Users\\Amin\\PycharmProjects\\deepLearning\\reference_arrays\\spectrum2.npy')
...
class TestGen(unittest.TestCase):
    def setUp(self):
        ...
        self.label_path = 'C:\\Users\\Amin\\PycharmProjects\\deepLearning\\labels.json'
        self.file_path = 'C:\\Users\\Amin\\PycharmProjects\\deepLearning\\exercise_data'
    ...
    def testInit(self):
        ...
        np.testing.assert_almost_equal(gen.next()[0], gen2.next()[0],
                                       err_msg="Possible error: Maybe the data is already "
                                               "shuffled during initialization.")
        np.testing.assert_almost_equal(gen.next()[1], gen2.next()[1],
                                       err_msg="Possible error: Maybe the lables are already "
                                               "shuffled during initialization.")
    ...
    def testResetIndex(self):
        ...
        np.testing.assert_almost_equal(b1[:66], b2[17:],
                                       err_msg="Possible error: The generator does not reuse the first "
                                               "elements of the first batch in case of overlapping batches"
                                               ". Please make sure to reuse the first elements in the first"
                                               "batch.")
        self.assertFalse(b1[65] is b2[-1],
                         msg="Possible error: The overlapping elements point to the same object. Please"
